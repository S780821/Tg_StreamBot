...
class Configs:
    ...
    CHANNEL_LINK = getenv("CHANNEL_LINK", "https://t.me/Xmarty_Updates")
    GROUP_LINK = getenv("GROUP_LINK", "https://t.me/Xmarty_Support")
    UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/S780821/Tg_StreamBot")

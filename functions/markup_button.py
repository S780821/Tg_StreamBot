    ...
    return InlineKeyboardMarkup(
        [
            ...
            [
                ...
                InlineKeyboardButton(
                    gm(chat_id, "maintainer"), url="https://t.me/xmartperson"
                ),
            ],
            [
                InlineKeyboardButton(
                    gm(chat_id, "channel"), url="https://t.me/Xmarty_Updates"
                ),
                InlineKeyboardButton(
                    gm(chat_id, "group_support"), url="https://t.me/Xmarty_Support"
                ),
            ],
            [
                InlineKeyboardButton(
                    gm(chat_id, "source_code"),
                    url="https://github.com/S780821/Tg_StreamBot",
                )
            ],
        ]
    )
